...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Eliminar el ultimo digito de la cadena cuando se pulsa el boton <
     *
     * siendo la primera condicion que si se encuentra con el numero sin estar vacio, este elimina el ultimo valor
     */
    private fun btnBorrarClicked() {
        ...
        if(calc.numTemp1.isEmpty())
            mensajeError("No se pueden borrar más numeros")
